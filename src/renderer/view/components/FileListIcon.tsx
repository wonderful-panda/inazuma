import { VOcticon, OcticonNames } from "./base/VOcticon";
...
const attrs: Record<string, { icon: OcticonNames; color: string; title: string }> = {
...
export const FileListIcon = _fc<{ statusCode: string }>(({ props: { statusCode } }) => {
  ...
  return <VOcticon class={diffIconStyle} name={attr.icon} color={attr.color} title={attr.title} />;
});
